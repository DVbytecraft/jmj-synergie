...
class UserModel(Base):
    ...
    reset_otp_attempts: Mapped[int] = mapped_column(SmallInteger, default=0, nullable=False)
    reset_session_token: Mapped[str | None] = mapped_column(String(128), nullable=True)
    reset_session_expires_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
...
class OrderItemModel(Base):
    ...
    invoiced_quantity: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
