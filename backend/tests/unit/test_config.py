...
def make_settings(**overrides: object) -> Settings:
    values: dict[str, object] = {
        "DATABASE_URL": "postgresql+asyncpg://user:pass@localhost:5432/jmj",
        "SECRET_KEY": "a" * 32,
...
def test_production_rejects_missing_transactional_email_config() -> None:
    with pytest.raises(ValidationError, match="Transactional email must be configured"):
        make_settings(
            ENVIRONMENT="production",
